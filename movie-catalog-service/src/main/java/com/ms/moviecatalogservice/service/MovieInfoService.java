...
public class MovieInfoService {
    ...
    public CatalogItem getCatalogItem(Rating rating) {
        ...
        logger.info("Performing REST API Call to movie-info to URL :- "+getUrl());

        Movie movie = restTemplate.getForObject(getUrl() + rating.getMovieId(), Movie.class);
        return new CatalogItem(movie.getName(), movie.getDesc(), rating.getRating());
    }

    public String getUrl(){
        return "http://movie-info/movies/";
    }
}
